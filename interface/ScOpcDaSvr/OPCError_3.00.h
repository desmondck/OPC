...
// MessageText: 
//
// The item ID is not defined in the server address space or no longer exists in the server
// address space. 
// 
...
// MessageText: 
// 
// The server does not support the requested data rate but will use the closest available
// rate. 
// 
...
// MessageText: 
// 
// The server does not support buffering of data items that are collected at a faster rate
